...
$kapan = date("Y");
$i = 0;
$sql = "SELECT * FROM `log` WHERE `tahun` = '$kapan' AND `kecamatan` = '$orang'";
$kueri = mysql_query($sql);

while ($hasil=mysql_fetch_array($kueri)) {
    $i=$i+1;
}
if($i==189){
?>
<table class="table table-bordered table-hover" width="150%">
	<strong><caption class="text-center" style="font-size:16px;">7 KELOMPOK DATA SISTEM PEMBANGUNAN DAERAH<br/>KABUPATEN PURBALINGGA<br/>PARUH TAHUN <?php echo $initahun; ?> </caption></strong>
